...
function Contact() {
  ...
  return (
    <section
      className="w-full h-screen flex items-center justify-center mt-[20%] "
      id="contact"
    >
      <div className="relative flex h-[500px] w-full items-center justify-center overflow-hidden  bg-background ">
        <div className="w-full flex flex-col items-center mb-24">
          ...
          <div className="flex gap-8 bg-gray-100 px-5 py-5 rounded-3xl border shadow-md hover:border-2 hover:border-orange-600 z-30">
            <img
              src={avatarImage}
              alt="avatar image"
            ...
            <button className="text-3xl font-normal" onClick={copyToClipboard}>
